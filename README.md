...
⚙️ Configuration
🔌 Base de données
Modifiez le fichier application.yml avec vos paramètres :
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/votre_base
    username: utilisateur
    password: mot_de_passe
Le schéma est généré automatiquement via Hibernate
Les scripts SQL sont exécutés au démarrage (si activés)
🔄 Profils Spring
...
Enregistre les métriques de résilience
Fournit une réponse de secours si configuré
🔧 Dépannage
